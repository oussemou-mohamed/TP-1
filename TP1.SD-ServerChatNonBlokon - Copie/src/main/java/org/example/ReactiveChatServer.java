...
import java.util.*;
public class ReactiveChatServer {
    private Map<SocketChannel, Integer> socketChannels = new HashMap<>();
    private int clientsCount;
    public static void main(String[] args) throws IOException {
        new ReactiveChatServer();
    }
    public ReactiveChatServer() {
        this.startServer();
    }
    //**************************************************************************************//
    public void startServer() {
        System.out.println("Th server is started using port=4444");
        try {
            ...
            while (true) {
                ...
                while (iterator.hasNext()) {
                    ...
                    } else if (selectionKey.isWritable()) {//System.out.println("a channel is ready for writing");
                    }
                    iterator.remove();
                }
            }
